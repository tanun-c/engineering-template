...
<?php if (arg(0) == 'node'): ?>
  <?php $node = node_load(arg(1));// var_dump($node); die;?>
  <?php if ($node && isset($node->field_cover_image)): ?>
  <div class="main-container container cover-container" style="background-image: url('<?php print file_create_url($node->field_cover_image['und'][0]['uri']); ?>')">
...
<div class="main-container <?php print $container_class; ?>">
  ...
  <div class="row">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <?php if (!empty($title) && !isset($node->field_cover_image)): ?>
        <h1 class="page-header"><?php print $title; ?></h1>
      <?php endif; ?>
